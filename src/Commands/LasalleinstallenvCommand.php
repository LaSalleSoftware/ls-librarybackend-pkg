...
class LasalleinstallenvCommand extends CommonCommand
{
    ...
    public function handle()
    {
        ...
        echo "\n\n";
        $this->info('================================================================================');
        $this->info('                  lslibrarybackend:lasalleinstallenv ');
        $this->info('================================================================================');
        echo "\n\n";
        ...
        echo "\n\n\n";
        $this->line('--------------------------------------------------------------------------');
        $this->line('        Congratulations! You finished lslibrarybackend:lasalleinstallenv!');
        $this->line('--------------------------------------------------------------------------');

        if ('basicfrontendapp' == env('LASALLE_APP_NAME')) {
            echo "\n\n";
            $this->info('************************************************************************************************');
            $this->info('  Please run "php artisan lslibrarybackend:lasalleinstallfrontendapp" to complete your installation');
            $this->info('************************************************************************************************');
            echo "\n\n";
        }
